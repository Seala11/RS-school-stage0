...
P.S: Я изменила расположение ссылок в навигации таким образом, чтобы навигация по блокам была визуально отделена от настроек сайта (темы и языка). В ТЗ указано, что "разрешены и даже приветствуются правки размеров и расположения криво нарисованных блоков".
`;
